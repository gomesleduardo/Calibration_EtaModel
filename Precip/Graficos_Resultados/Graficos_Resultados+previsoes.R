...
as.numeric(sigma2t.chain.final)
a.phi.prior <- 1
b.phi.prior <- 0.1

#------ sigma2t ------#
d <- density(x = as.numeric(sigma2t.chain.final), adjust = 5)
plot(d, xlab=expression(sigma^2), main="",ylab="Densidade",cex.lab=1.5,cex.axis=1.5)
h1 <- d$x[d$x >= as.numeric(quantile( as.numeric(sigma2t.chain.final),c(0.025))) & d$x <= as.numeric(quantile( as.numeric(sigma2t.chain.final),c(0.975)))] # ?rea a ser pintada
h2 <- d$y[which(d$x >= as.numeric(quantile( as.numeric(sigma2t.chain.final),c(0.025))) & d$x <= as.numeric(quantile( as.numeric(sigma2t.chain.final),c(0.975))))]
polygon(c(min(h1),h1,max(h1)),c(0,h2,0),col="gray80")
lines(d,lwd=2)
lines(seq(min(d$x),max(d$x),.01),exp(log.phi.prior(seq(min(d$x),max(d$x),.01))),lwd=2,lty=2)
abline(h=0)
...
points(as.numeric(Ft.numforecast[2,1:n,2:(T.new+1)]),
       as.numeric(Yt.k[,,2:(T.new+1)]),pch=19,cex=2)
...
for (k in 2:(T.new+1))
{
  points(rowMedians(Yt.prev[1:n,,k]),
         as.numeric(Yt.k[,,k]),pch=19,cex=2)
}
...
{
  print(l)
  png(filename = paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Graficos_Resultados/Previsoes/",
                        "cap4_previsoes_",as.character(coords.stations$codigo[l]),
                        "diario.png"),
      width = 640, height = 480)
  par(mar=c(6.5, 5.5, .5, 1))
  plot(0,type="n",ylim=c(0,6),xlim=c(1,(T.new+2)),
       ylab="Velocidade do Vento (m/s)",xlab="Horizonte (h)", axes= F,
       cex.lab=2.5)
  ...
  polygon(c(rev(3:(T.new+2)),3:(T.new+2)),
          ...
          col="grey80",border=NA)
  lines(1:3,c(Ft[2,l,T],Ft[2,l,T+1],Ft.numforecast[2,l,2]),lwd=2,t="o",pch=17,cex=1.5)
  lines(3:(T.new+2),Ft.numforecast[2,l,2:(T.new+1)],lwd=2,lty=2,t="o",pch=17,cex=1.5)
  points(1,ifelse(Yt[l,,T]>0,Yt[l,,T],0),pch=19,col=2,cex=1.5)
  points(2,ifelse(Yt[l,,T+1]>0,Yt[l,,T+1],0),pch=19,col=2,cex=1.5)
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)]),col="#0000ff",lwd=2,t="o",pch=19,cex=1.5)
  dev.off()
}
...
{
  print(l)
  png(filename = paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Graficos_Resultados/Previsoes2/",
                        "cap4_previsoes_",as.character(coords.stations$codigo[l]),
                        "diarioB.png"),
      width = 640, height = 480)
  par(mar=c(6.5, 5.5, .5, 1))
  ...
  points(2,ifelse(Yt[l,,T+1]>0,Yt[l,,T+1],0),pch=19,col=2,cex=1.5)
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)]),col="#7990c0",lwd=2,t="o",pch=15,cex=1.5)
  dev.off()
}
...
{
  print(l)
  png(filename = paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Graficos_Resultados/Previsoes3/",
                        "cap4_previsoes_",as.character(coords.stations$codigo[l]),
                        "diarioC.png"),
      width = 640, height = 480)
  par(mar=c(6.5, 5.5, .5, 1))
  ...
  points(2,ifelse(Yt[l,,T+1]>0,Yt[l,,T+1],0),pch=19,col=2,cex=1.5)
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)]),col="#00CC99",lwd=2,t="o",pch=18,cex=1.5)
  dev.off()
}
...
for (l in 1:59)
{
  ...
  polygon(c(rev(3:(T.new+2)),3:(T.new+2)),
          c(rev(colQuantiles(Yt.prev[l,,2:(T.new+1)],probs = 0.1)),
            colQuantiles(Yt.prev[l,,2:(T.new+1)],probs = 0.9)),
          col="grey80",border=NA)
  abline(v=seq(2,26,6),lty=2,col="grey80")
  lines(1:3,c(Ft[2,l,T],Ft[2,l,T+1],Ft.numforecast[2,l,2]),lwd=2,pch=17,t="o",cex=1.5)
  lines(3:(T.new+2),Ft.numforecast[2,l,2:(T.new+1)],lwd=2,lty=2,pch=17,t="o",cex=1.5)
  points(1,ifelse(Yt[l,,T]>0,Yt[l,,T],0),pch=19,col=2,cex=1.5)
  points(2,ifelse(Yt[l,,T+1]>0,Yt[l,,T+1],0),pch=19,col=2,cex=1.5)
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)]),col=4,lwd=2,pch=19,t="o",cex=1.5)
  dev.off()
}
...
for (l in 1:59)
{
  ...
  points(2,ifelse(Yt[l,,T+1]>0,Yt[l,,T+1],0),pch=19,col=2,cex=1.5)
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)]),col="#7990c0",lwd=2,pch=15,t="o",cex=1.5)
  dev.off()
}
...
for (l in 1:59)
{
  ...
  points(2,ifelse(Yt[l,,T+1]>0,Yt[l,,T+1],0),pch=19,col=2,cex=1.5)
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)]),col="#00CC99",lwd=2,pch=18,t="o",cex=1.5)
  dev.off()
}
