...
{
  print(l)
  png(filename = paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Graficos_Resultados/Previsoes4/",
...
{
  print(l)
  png(filename = paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Graficos_Resultados/Previsoes5/",
                        "cap4_previsoes_",as.character(coords.stations$codigo[l]),
                        "diarioE.png"),
      width = 640, height = 480)
  par(mar=c(6.5, 5.5, .5, 1))
...
{
  print(l)
  png(filename = paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Graficos_Resultados/Previsoes6/",
                        "cap4_previsoes_",as.character(coords.stations$codigo[l]),
                        "diarioF.png"),
      width = 640, height = 480)
  par(mar=c(6.5, 5.5, .5, 1))
...
for (l in (1:59)[-c(34,42,59)])
{
  ...
  plot(0,type="n",ylim=c(0,9),xlim=c(1,(T.new+2)),
       ...
       cex.lab=2.5)
  axis(1,seq(2,26,6),c("0",paste0("+",seq(6,24,6))),cex.axis=2.5)
  axis(2,seq(0,9,2),seq(0,9,2),cex.axis=2.5)
  # axis(2,seq(0,12,3),seq(0,12,3),cex.axis=2.5)
  axis(3,seq(2,26,6),c(paste0(seq(12,18,6),"h"),paste0(seq(0,12,6),"h")),cex.axis=2.5)
  abline(h=0)
  # polygon(c(rev(3:(T.new+2)),3:(T.new+2)),
...
for (k in 2:(T.new+1))
{
  points(rowMedians(Yt.prev[1:n,,k])+runif(1,0,3),
         as.numeric(Yt.k[,,k]),pch=19,cex=2)
}
...
for (l in 1:59)
{
  ...
  points(3:(T.new+2),Yt.k[l,,2:(T.new+1)],pch=19,col=2,cex=1.5)
  set.seed(1)
  lines(3:(T.new+2),colMeans(Yt.prev[l,,2:(T.new+1)])+runif(1,0,3),col="#7990c0",lwd=2,pch=15,t="o",cex=1.5)
  dev.off()
}
