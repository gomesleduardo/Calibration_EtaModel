...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_beta0_diario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)

par(mar=c(5.5, 5.5, 3, .5))
A <- boxplot(BETA0,outline = F,col="grey80",
        ylab=expression(beta[0]),xlab="Meses",
        cex.lab=2.5,cex.axis=2.5,plot = F)
...
boxplot(A$stats,outline = F,
        names=c("Dez","Jan","Fev","Mar","Abr","Mai",
                "Jun","Jul","Ago","Set","Out","Nov"),
        las = 2, xaxt ='n', axes = FALSE,
        ylab=expression(beta[0]),xlab="",
        cex.lab=2.5,cex.axis=2.5,ylim=c(min(A$stats),1.2))
...
for (i in 1:12)
{
  ...
  points(i,A$stats[3,i],pch=4,lwd=3)
}
...
axis(3, seq(-1, 14, 3),
     ...
     # las = 2,
     cex.axis = 2.5)
abline(v = seq(.5, 14, 3), lty = 2, col = "grey30")

dev.off()

#------ Beta1
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_beta1_diario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)

par(mar=c(5.5, 5.5, 3, .5))
A <- boxplot(BETA1,outline = F,col="grey80",
...
#------ Phi
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_phi_diario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)

par(mar=c(5.5, 5.5, 3, .5))
A <- boxplot(PHI,outline = F,col="grey80",
             ylab=expression(beta[1]),xlab="Meses",
             cex.lab=2.5,cex.axis=2.5,plot = F)
...
#------ Lambda
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_lambda_diario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)

par(mar=c(5.5, 5.5, 3, .5))
A <- boxplot(LAMBDA,outline = F,col="grey80",
             ylab=expression(beta[1]),xlab="Meses",
             cex.lab=2.5,cex.axis=2.5,plot = F)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes/",
                  "cap4_concord_prevnum_diario.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes/",
                  "cap4_concord_prevnumcalib_diario.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
#------ Graficos - Concordancia ------#
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes2/",
                  "cap4_concord_prevnum_diarioB.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes2/",
                  "cap4_concord_prevnumcalib_diarioB.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
#------ Graficos - Concordancia ------#
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes3/",
                  "cap4_concord_prevnum_diarioC.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes3/",
                  "cap4_concord_prevnumcalib_diarioC.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
#------ Beta0
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_beta0_horario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)
...
#------ Beta1
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_beta1_horario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)
...
#------ Lambda
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/",
                  "cap4_boxplot_lambda_horario.eps"),
           width = 7, height = 6,
           horizontal = TRUE)
...
#------ Graficos - Concordancia ------#
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes/",
                  "cap4_concord_prevnum_horario.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes/",
                  "cap4_concord_prevnumcalib_horario.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
#------ Graficos - Concordancia ------#
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes2/",
                  "cap4_concord_prevnum_horarioB.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes2/",
                  "cap4_concord_prevnumcalib_horarioB.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
#------ Graficos - Concordancia ------#
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes3/",
                  "cap4_concord_prevnum_horarioC.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
...
postscript(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Graficos_Resultados/Previsoes3/",
                  "cap4_concord_prevnumcalib_horarioC.eps"),
           width = 6, height = 6,
           horizontal = TRUE)
