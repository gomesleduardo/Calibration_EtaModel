...
for (data.c in 1:12)
{
  ...
  #     ft.k <- t(Ft.new[,parc.prev,k])%*%at.k[,,k]
  #     Qt.k <- symmetricMatrix(t(Ft.new[,parc.prev,k])%*%Rt.k[,,k]%*%Ft.new[,parc.prev,k]+(Vt.c.k[,,k])[parc.prev,parc.prev])
  ...
  #   lines(2:(T.new+1),colMedians(Yt.prev[l,,2:(T.new+1)]),lty=2,lwd=2)
  ...
  rm(D.new)
  rm(Vt.c.k)
  save.image(paste0("C:/Users/b207056565/Desktop/Calibration_EtaModel/Wind_Speed_10m/Aplicacao/Resultados/Horarios/result_horario",
                    datas[data.c],"STEMOS.Rda"))
